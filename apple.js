...
const API_KEY = "caa42ed972msh0009c27bca629bdp103b6ejsn88ec17481d25";  // <-- Put your RapidAPI key here
const symbol = "AAPL";
...
async function fetchQuote() {
  ...
  // Parse current price and change from summary data
...
// Fetch historical candle data (Yahoo returns timestamps and close prices)
async function fetchHistorical(range) {
  ...
  const timestamps = result.timestamp; // UNIX timestamps array
  const closes = result.indicators.adjclose[0].adjclose; // adjusted close prices array
...
// Map buttons' data-range attribute to Yahoo Finance range strings
const rangeMap = {
  7: "1mo",
  30: "3mo",
  90: "6mo",
